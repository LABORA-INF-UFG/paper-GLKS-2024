# GRAFICO DE CACHE HIT POR TAMANHO
...
def read_data(file_name):
    ...
    for line in lines:
        att = float(line.split(' ')[1])
        req = float(line.split(' ')[2])
...
def plot():
    ...
    ax.set_ylabel("Cache hit: tamanho (%)",fontsize=26)
    ...
    plt.savefig("hits_s.pdf", bbox_inches='tight')
    plt.savefig("hits_s.png", bbox_inches='tight')
